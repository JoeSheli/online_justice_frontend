...
function CyberDefense() {
  return (
    <div className="flex justify-between items-center w-full">
      <div className="flex flex-col gap-3 max-w-[31.5rem]">
        <div className="text-[2rem] font-medium capitalize leading-[2.5rem]">Spreading cyber defense for our clients</div>
        <div className="text-[#707070] leading-[1.2rem] text-[1rem]">
